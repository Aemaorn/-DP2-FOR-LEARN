...
public record Jp006AcceptorInfo(
    Guid? Id,
    ...
    int Sequence)
    : AcceptorRequest(Id, AcceptorType, UserId, Sequence, CommitteePositionsCode, IsUnableToPerformDuties)
{
    public class Validator : Validator<Jp006AcceptorInfo>
    {
        public Validator()
        {
...
public record Jp006AcceptorResponseInfo(
    ...
    [param: Description("รหัสผู้ปฏิบัติหน้าที่แทน")]
