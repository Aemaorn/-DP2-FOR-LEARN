...
public record RejectPoSapRequest(
...
public class RejectPoSapEndpoint : PoSapEndpointBase<RejectPoSapRequest, Results<Ok, NotFound<string>, BadRequest<string>>>
{
    public RejectPoSapEndpoint(ILogger<RejectPoSapEndpoint> logger, Dp2DbContext dbContext)
    ...
    public override void Configure()
    {
        this.Options(b =>
            b.WithTags("ContractAmendment/PoSap")
             .WithName("RejectPoSap")
             .Accepts<RejectPoSapRequest>("application/json"));
        this.Post("contract-amendment/{ContractAmendmentId:guid}/po-sap/{Id:guid}/reject");
    }

    protected override async ValueTask<Results<Ok, NotFound<string>, BadRequest<string>>> HandleRequestAsync(RejectPoSapRequest req, CancellationToken ct)
    {
        var poSap =
