...
file sealed record PublicProcurementProgressListIntermediate(
    Guid PlanId,
    string PlanNumber,
    int BudgetYear,
...
public class GetPublicProcurementProgressList
    : EndpointBase<GetProcurementProgressListRequest, Ok<PaginatedQueryResult<GetProcurementProgressListItemResponse>>>
{
    private readonly Dp2DbContext dbContext;

    public GetPublicProcurementProgressList(Dp2DbContext dbContext, ILogger<GetPublicProcurementProgressList> logger)
        : base(logger)
    {
    ...
    public override void Configure()
    {
        this.Options(b =>
            b.WithTags("Dashboard")
             .WithName("GetPublicProcurementProgressList")
             .Produces<Ok>());
        this.Get("dashboard/public/procurement-progress");
        this.AllowAnonymous();
    }
        ...
        CancellationToken ct)
    {
        ...
        var projected = plansQuery
            ...
            .Select(x => new PublicProcurementProgressListIntermediate(
                x.p.Id.Value,
        ...
        var paginated = await Codehard.Infrastructure.EntityFramework.PaginatedList<PublicProcurementProgressListIntermediate>
