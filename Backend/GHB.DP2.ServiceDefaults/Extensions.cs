...
public static class Extensions
{
    ...
    public static TBuilder AddServiceDefaults<TBuilder>(this TBuilder builder) where TBuilder : IHostApplicationBuilder
    {
        ...
        builder.Services.ConfigureHttpClientDefaults(http =>
        {
            ...
            // NOTE: this applies to EVERY HttpClient in the app. The library defaults are
            // AttemptTimeout 10s / TotalRequestTimeout 30s, which cut off slow third-party
            // calls (COI, Watchlist) at 10s. Raise them so slow upstreams can finish.
            http.AddStandardResilienceHandler(o =>
            {
                ...
                o.CircuitBreaker.SamplingDuration = TimeSpan.FromSeconds(45);
            });
