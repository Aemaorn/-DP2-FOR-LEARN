...
public partial class PPettyCashAcceptor : AcceptorInfoEntity, IHasSoftDelete
{
    ...
    public static PPettyCashAcceptor Create(
        AcceptorType type,
        SuUser user,
        int sequence)
    {
        var acceptor = new PPettyCashAcceptor
        {
            Id = AcceptorId.New(),
        };
    ...
    public static PPettyCashAcceptor CreateWithPending(
      AcceptorType type,
      SuUser user,
      int sequence)
    {
