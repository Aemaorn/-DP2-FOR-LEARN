...
public partial struct PInvitedEntrepreneurCheckerId
{
    public static PInvitedEntrepreneurCheckerId New() => From(Guid.CreateVersion7());
}

public class PInvitedEntrepreneurChecker :
    IHasVendorQualificationCheckerInfo
{
    public PInvitedEntrepreneurCheckerId Id { get; init; }
    ...
    public static IHasVendorQualificationCheckerInfo Create(
        ...
        string? remark)
    {
        return new PInvitedEntrepreneurChecker
        {
            Id = PInvitedEntrepreneurCheckerId.New(),
            CheckType = checkType,
            Result = result,
            ResultAt = resultAt,
            Remark = remark,
