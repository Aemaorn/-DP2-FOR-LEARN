...
public class AnnouncementReportConfiguration : EntityTypeConfigurationBase<AnnouncementReport, Dp2DbContext>
{
    protected override void EntityConfigure(EntityTypeBuilder<AnnouncementReport> builder)
    {
        builder.ToTable(nameof(AnnouncementReport), nameof(AnnouncementInfo));
        ...
        builder.Property(a => a.Discretion);

        builder.Property(a => a.AnnouncementReportTypeCode)
        ...
        builder.HasOne(a => a.AnnouncementCategory)
               .WithMany()
               .HasForeignKey(a => a.AnnouncementReportTypeCode)
