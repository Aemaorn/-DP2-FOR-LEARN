...
public class CaContractDraftEquipmentRentalConfiguration : EntityTypeConfigurationBase<CaContractDraftEquipmentRental, Dp2DbContext>
{
    protected override void EntityConfigure(EntityTypeBuilder<CaContractDraftEquipmentRental> builder)
    {
        builder.ToTable(nameof(CaContractDraftEquipmentRental), nameof(ContractAgreement));
