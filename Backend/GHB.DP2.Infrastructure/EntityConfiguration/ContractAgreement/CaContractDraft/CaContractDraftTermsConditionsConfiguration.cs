...
public class CaContractDraftTermsConditionsConfiguration : EntityTypeConfigurationBase<CaContractDraftTermsConditions, Dp2DbContext>
{
    protected override void EntityConfigure(EntityTypeBuilder<CaContractDraftTermsConditions> builder)
    {
        builder.ToTable(nameof(CaContractDraftTermsConditions), nameof(ContractAgreement));
