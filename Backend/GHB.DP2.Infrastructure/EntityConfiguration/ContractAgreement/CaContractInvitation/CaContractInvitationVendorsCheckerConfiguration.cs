...
public class CaContractInvitationVendorsCheckerConfiguration : EntityTypeConfigurationBase<CaContractInvitationVendorChecker>
{
    protected override void EntityConfigure(EntityTypeBuilder<CaContractInvitationVendorChecker> builder)
    {
        builder.ToTable(nameof(CaContractInvitationVendorChecker), nameof(ContractAgreement));
