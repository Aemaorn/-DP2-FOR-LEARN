...
public class PJp006EntrepreneurShareholdersConfiguration : EntityTypeConfigurationBase<PPurchaseOrderEntrepreneurShareholders, Dp2DbContext>
{
    protected override void EntityConfigure(EntityTypeBuilder<PPurchaseOrderEntrepreneurShareholders> builder)
    {
        builder.ToTable(nameof(PPurchaseOrderEntrepreneurShareholders), nameof(Procurement));
        ...
        builder.HasMany(es => es.PurchaseOrderEntrepreneurShareholderCheckers)
               .WithOne(c => c.PPurchaseOrderEntrepreneurShareholder)
