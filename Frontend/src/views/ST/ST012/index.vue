...
<template>
  <TitleHeader label="อำเภอ/เขต">
    <template #action>
      <Button label="เพิ่มอำเภอ/เขต" icon="pi pi-plus" severity="primary" variant="outlined"
        class="hover:bg-red-200 hover:text-red-900 bg-red-50" @click="() => router.push({ name: 'st012Detail' })" />
    </template>
  </TitleHeader>
  <Card class="my-4">
    <template #content>
