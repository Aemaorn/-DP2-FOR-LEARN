...
<template>
  <div class="grid grid-rows-1 gap-5">
    ...
    <Warranty :body="value" :disable="props.disable" label="สัญญาข้อ 8 การรับประกันความชำรุดบกพร่อง" />
    <ContractPerformance :body="value" :disable="props.disable" label="สัญญาข้อ 9 หลักประกันการปฏิบัติตามสัญญา" />
    <Mulct :body="value" :disable="props.disable" label="สัญญาข้อ 11 ค่าปรับ" />
  </div>
</template>