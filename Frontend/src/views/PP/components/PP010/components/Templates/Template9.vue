...
<template>
  <div class="grid grid-rows-1 gap-5">
    ...
    <Payment :body="value" :disable="props.disable" label="สัญญาข้อ 3 ค่าจ้างงานออกแบบและการจ่ายเงิน" />
    <Mulct :body="value" :disable="props.disable" label="สัญญาข้อ 4 หน้าที่ของผู้ให้บริการงานออกแบบ" />
    <ContractPerformance :body="value" :disable="props.disable" label="สัญญาข้อ 11 หลักประกันการปฏิบัติตามสัญญา" />
  </div>
</template>