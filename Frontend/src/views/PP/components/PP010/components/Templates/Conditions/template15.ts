...
const accessFieldAgreement = {
  mainTitle: { isShow: true, label: 'ผู้ให้เช่าตกลงให้เช่าเครื่องถ่ายเอกสาร' },
  brand: { isShow: true, label: 'ยี่ห้อ' },
  model: { isShow: true, label: 'รุ่น' },
  machineNo: { isShow: true, label: 'หมายเลขเครื่อง' },
  period: { isShow: true, label: 'ระยะเวลาการเช่ามีกำหนด (ปี)' },
  ...
  startDate: { isShow: true, label: 'ตั้งแต่วันที่' },
  endDate: { isShow: true, label: 'จนถึง' },
  deliveryDetail: { isShow: true },
} as AgreementField;

const accessFieldPrinterRental = {
  unitPerMonth: { isShow: true, label: 'ค่าเช่ารายเดือน เดือนละ/เครื่อง' },
  quantity: { isShow: true, label: 'จำนวน' },
  monthlyRental: { isShow: true, label: 'ค่าเช่ารายเดือนรวม เดือนละ' },
  document: { isShow: true, label: 'ประเมินจากจำนวนสำเนาเอกสาร เดือนละ' },
  documentNotEnough: { isShow: true, label: 'กรณีจำนวนถ่ายเอกสารไม่ถึง' },
  copyRatePerSheet: { isShow: true, label: '(เปลี่ยนเป็นคิดคำนวนอัตราสำเนาแผ่นละ)' },
} as PrinterRentalField;
