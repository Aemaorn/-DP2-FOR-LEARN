...
const DefectWarranty = defineAsyncComponent(() => import('../Sub/DefectWarranty.vue'));
...
<template>
  <div class="grid grid-rows-1 gap-5">
    ...
    <ComputerLeaseInfo :body="value" :disable="props.disable" label="สัญญาข้อ 3 การรับรองและการอนุญาตให้ใช้สิทธิ" />
    <PartOfContract :dropdown="store.dropdown.attacementTypeOptions" :body="value" :disable="props.disable"
      label="สัญญาข้อ 4 เอกสารอันเป็นส่วนหนึ่งของสัญญา" />
    <Delivery :body="value" :disable="props.disable" label="สัญญาข้อ 5 การส่งมอบและการจ่ายเงิน" />
    <Payment :body="value" :disable="props.disable" label="สัญญาข้อ 7 การชำระเงิน" />

    <DefectWarranty label="สัญญาข้อ 9 การรับประกันความชำรุดบกพร่อง" :body="value" :disable="props.disable" />
