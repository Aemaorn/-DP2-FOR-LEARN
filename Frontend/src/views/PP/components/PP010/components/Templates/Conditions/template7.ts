...
const accessFieldContractTermination1 = {
  year: { isShow: true, label: 'ผู้รับจ้างจะต้องทำงานให้แล้วเสร็จ ภายใน (ปี)' },
  month: { isShow: true, label: '(เดือน)' },
  day: { isShow: true, label: '(วัน)' },
} as ContractTerminationField;

const accessFieldContractTermination2 = {
  startDate: { isShow: true, label: 'ผู้รับจ้างต้องเริ่มทำงาน ภายในวันที่' },
  endDate: { isShow: true, label: 'ผู้รับจ้างต้องทำงานให้เสร็จบริบูรณ์ภายในวันที่' },
} as ContractTerminationField;
...
export {
  ...
  accessFieldContractTermination1,
  accessFieldContractTermination2,
