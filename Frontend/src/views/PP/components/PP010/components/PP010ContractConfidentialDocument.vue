...
<template>
  <Card>
    <template #content>
      ...
      <ChEditor v-if="store.body.confidentialContractDraftDocumentId" :docId="store.body.confidentialContractDraftDocumentId"
        :docName="new Date().toISOString()" :readonly="props.readonly"
        ref="documentRef" :key="store.body.confidentialContractDraftDocumentId"
        :save="props.save"
