...
<template>
  <Card>
    <template #content>
      <TitleHeader label="เอกสารประกาศผู้ชนะ" />
      <ChEditor v-if="store.body.winnerDocumentId" :docId="store.body.winnerDocumentId" docName="bankPP005"
        :readonly="props.readonly" ref="documentRef" :key="store.body.winnerDocumentId"
        :save="props.save"
