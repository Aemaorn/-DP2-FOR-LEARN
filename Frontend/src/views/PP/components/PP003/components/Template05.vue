...
import type { TPP003Body } from '@/views/PP/models/PP003/pp003Model';
import { PriceSourceSection, SoftwareCostSection } from './sub/template05';
...
<template>
  <PriceSourceSection v-model="value.budgetAllocations" detailType="basic" :states="props.states" />
  <SoftwareCostSection v-if="value.expenseDescription" v-model="value.expenseDescription" :states="props.states" />
</template>
