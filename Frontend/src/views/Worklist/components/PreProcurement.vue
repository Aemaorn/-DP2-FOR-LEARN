...
<template>
  <DataView :value="store.worklistRes.preProcurement?.page?.data" data-key="id">
    <template #list="{ items }">
  ...
  <Pagination :page-number="store.criteria.pageNumber" :page-size="store.criteria.pageSize"
    :total-record="store.worklistRes.preProcurement?.page?.totalRecords" @change="store.onChangePageSizeAsync" />
</template>
