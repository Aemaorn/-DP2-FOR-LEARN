        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
          <button type="button"
            ...
            <div class="mt-3 text-center">
              ...
              <p class="text-xs text-gray-500 mt-1">ดึงข้อมูลจาก PR / สัญญา / จัดซื้อจัดจ้างที่มีในระบบ</p>
            </div>
          </button>
          ...
          <button type="button"
            ...
            <div class="mt-3 text-center">
              ...
              <p class="text-xs text-gray-500 mt-1">กรอกข้อมูลด้วยตัวเองทุกฟิลด์ ไม่ผูกกับเอกสารต้นทาง</p>
            </div>
          </button>
        </div>
